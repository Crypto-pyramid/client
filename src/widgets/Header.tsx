  ...
  const socialLinks = (
    <div style={{marginLeft: 'auto'}}>
      <OutLink href="https://twitter.com/cryptopyramid2">
        <img src={isHoverdTwitter ? link_twitter_d: link_twitter} alt="twitter" className={classes.socialLink}
          style={{marginLeft: '0px'}}
          onMouseOver={() => setIsHoverdTwitter(true)}
          onMouseOut={() => setIsHoverdTwitter(false)}/>
      </OutLink>
      <OutLink href="https://discord.gg/AN3dUeMN">
        <img src={isHoverdDiscord ? link_discord_d : link_discord} alt="discord" className={classes.socialLink}
          onMouseOver={() => setIsHoverdDiscord(true)}
          onMouseOut={() => setIsHoverdDiscord(false)}/>
      </OutLink>
      <OutLink href="https://www.youtube.com/@cryptopyramid">
        <img src={isHoverdYoutube ? link_youtube_d : link_youtube} alt="youtube" className={classes.socialLink}
      ...
      <OutLink href="https://www.instagram.com/cryptopyramidofficial/">
        <img src={isHoverdInstagram ? link_instagram_d : link_instagram} alt="instagram" className={classes.socialLink}
        ...
        <div className={classes.cc}>
          ...
          {width > 1100 ? (
            ...
            <div onClick={openLogout}>
              <img src={isHoverdMenu ? menu_dark : menu} alt="menu" className={classes.socialLink}
